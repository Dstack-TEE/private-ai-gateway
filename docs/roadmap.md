...
| ACI E2EE v2 compatibility | Implemented | The pre-PR field-level contract is enabled by default: X25519 and secp256k1 suites, JCS field AAD, replay protection, buffered and streaming response encryption, and attested key selection. It requires no workload identity key. |
