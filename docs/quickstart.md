...
SKIP  id-5         private-key custody and subject per policy [9.1(5)] — custody policy not implemented in this CLI yet (see apps/desktop/aci/src/verifier/dstack.rs); subject: null (no policy constraints applied)
