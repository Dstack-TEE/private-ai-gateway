...
/// away messages the caller could have acted on. A host under some TLD outside
/// this list survives — that is the accepted cost of not discarding good errors,
/// and `://` plus the opaque-id check still catch the common shapes.
const HOST_TLDS: &[&str] = &[
    "com", "net", "org", "io", "ai", "dev", "cloud", "app", "co", "cn", "us", "eu", "uk", "de",
    "fr", "jp", "in", "me", "sh", "gg", "xyz", "tech", "run", "info", "biz", "local", "internal",
];
