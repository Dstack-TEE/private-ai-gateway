...
pub use request_features::PrefixHashKey;
...
pub struct Middleware {
    ...
    /// Keys the consult `prefixHash`; see `request_features::PrefixHashKey`.
...
impl Middleware {
    pub fn new(prefix_hash_key: PrefixHashKey, config: &MiddlewareConfig) -> Result<Self, String> {
        Ok(Self {
...
mod tests {
    ...
    async fn handle_catalog_relays_control_response() {
        ...
        let middleware = new_middleware(&MiddlewareConfig {
