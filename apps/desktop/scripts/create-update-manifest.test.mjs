...
test("release manifests use signed platform artifacts and reject incomplete releases", async () => {
  ...
  const run = () => promisify(execFile)(process.execPath, ["scripts/create-update-manifest.mjs", directory, "0.1.1", "Dstack-TEE/private-ai-gateway"]);
  try {
