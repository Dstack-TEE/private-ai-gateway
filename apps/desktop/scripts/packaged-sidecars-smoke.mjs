...
try {
  ...
  for (const agent of ["codex", "claude-code", "opencode", "pi", "hermes", "openclaw"]) {
  ...
  console.log("Installed helper: six isolated token reads and missing/deleted/unknown-agent failures passed");
} finally {
