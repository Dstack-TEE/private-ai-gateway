...
export default memo(function UsagePlot({ rows, series, monthly, metric, formatValue }: ReturnType<typeof modelChartData> & { metric: UsageMetric; formatValue(value: number): string }) {
