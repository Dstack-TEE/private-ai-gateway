...
const ACTIVITY: GatewayState["activity"] = [
  usage({ id: "51be02", method: "POST", path: "/v1/messages", model: "openai/gpt-oss-20b", status: 200, streamed: true, receiptId: "rcpt-51be02", verified: true, detail: "receipt verified", at: now - 80, agent: "claude-code", localPolicyApplied: true, rewritten: true, leftDevice: true, inputTokens: 1260, outputTokens: 284, cacheReadTokens: 800, costUsd: 0.0009 }),
  usage({ id: "7f3a9c", method: "POST", path: "/v1/responses", model: "deepseek/deepseek-v4-flash-0731", status: 200, streamed: true, receiptId: "rcpt-7f3a9c", verified: true, detail: "receipt verified", at: now - 120, agent: "codex", localPolicyApplied: true, rewritten: false, leftDevice: true, inputTokens: 880, outputTokens: 412, costUsd: 0.0005 }),
